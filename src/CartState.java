    ...
    public String getToken(String prompt) {
        do {
            try {
                ...
                StringTokenizer tokenizer = new S tringTokenizer(line,"\n\r\f");
    ...
    private void modifyCart() {
        ...
        while ((choice = Integer.parseInt(getToken("Enter a number"))) != 0) {
            ...
            case 2: {
                ...
                w  hile(!warehouse.isProduct(pID)){
                    System.out.print(
                            "This product does not exist. Please enter a valid product ID or press 0 to cancel  : ");
                ...
                System.out.prin
                         t("The current price of this item is $"+ String.format("%.2f", warehouse.getPrice(pID, sID)) +".");
                ...
                if (warehouse.ad dToCart((Integer.parseInt(context.getUser())), pID, qty, sID)){
                    System
                               .out.print("Item successfully added to cart.\nThis purchase would cost $"+String.format("%.2f", totalPrice)+".\n\n");
                } else {
            ...
            case 3: {
                ...
                int pID = Integer
                        .parseInt(getToken("What is the ID of the product you're removing from your cart?  : "));

                while (!w arehouse.isProduct(pID)){
                    System.out.print(
                            "This product does not exist. Please enter a valid product ID or press 0 to cancel  : ");
                    pID = Integer
                            .parseInt(getToken("What is the ID of the product you're removing from your cart?  : "));
                ...
                System.out.prin
                        ...
                        t("The current price of this item is $"+ String.format("%.2f", warehouse.getPrice(pID, sID)) +" and there are "+ warehouse.getCartQuantity(Integer.parseInt(context.getUser()), pID, sID) +" items in the cart.");
                int qty = Integer.parseInt(getToken("\nHow many items would you like to remove?  : "));
                  ...
                  while(qty < 0 || warehouse.getCartQuantity(Integer.parseInt(context.getUser()), pID, sID) < qty){
                    sID = Integer.parseInt(getToken(
                            "You cannot remove this number of items. Please enter a valid amount or press 0 to cancel  : "));
                          if(sID == 0){  
                        break;
                    }
                }
                ...
                if (warehouse.removeFromCart(Integer.parseInt(context.getUser()), pID, qty, sI
                        D) && (qty == oldNumOfItems)){
                    System.out.println("Item successfully removed from cart");
                } else if (qty < oldNumOfItems) {
                    System.out.println(
                            "There are " + warehouse.getCartQuantity(Integer.parseInt(cont
                                     ext.getUser()), pID, sID)+" items of this product remaining in the cart.");
                    } else {
            ...
            case 4: {
                ...
                System.out.print(
                         "The current price of this item is $"+ String.format("%.2f", warehouse.getPrice(pID, sID)) +".");
