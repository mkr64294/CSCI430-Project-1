...
public class Supplier {
    ...
    // adding an item to the product list, takes in a String with name of the
    // product to add
    ...
    // removes item from the product list will return true if successful and false
    // if product could not be found in list
    ...
    // this is to allow integration with toString() printing all supplier
